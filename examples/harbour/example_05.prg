...
PROCEDURE Main()
   ...
   pWindow := SDL_CreateWindow( "Tutorial 5", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1125, 968, 0 )
   IF pWindow == NIL
   ...
   DO WHILE ! lQuit
      ...
      SDL_RenderCopy( pRenderer, pTexture, { 0, 0, 1125, 968 }, { 0, 0, 1125, 968 } )
